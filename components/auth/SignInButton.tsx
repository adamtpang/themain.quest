...
export function SignInButton({
  ...
  if (!clerkReady) {
    return (
      <Button disabled size="lg" className="quest-button h-12 w-full text-base">
        Owner sign-in setup required
      </Button>
    );
  }

  return (
    <ClerkSignInButton mode="modal" forceRedirectUrl={safeCallback}>
      <Button
        size="lg"
